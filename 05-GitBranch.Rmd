...
```{r imagebranch0, echo=FALSE, out.width="700px", fig.align='center'}
...
```{r imagebranch1, echo=FALSE, out.width="700px", fig.align='center'}
knitr::include_graphics("images/namebranch.PNG")
```
...
```{r imagebranch2, echo=FALSE, out.width="700px", fig.align='center'}
knitr::include_graphics("images/comparepull.PNG")
```
...
```{r imagebranch3, echo=FALSE, out.width="700px", fig.align='center'}
...
```{r imagebranch4, echo=FALSE, out.width="700px", fig.align='center'}
