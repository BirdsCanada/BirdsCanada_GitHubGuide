...
Having such fine grained control over which changes to commit is certainly handy, but it's perfectly accesptable to just stage all changes on each commit.
