...
**clone** - create a copy of a Git repo maintaining a direct link to the original repository.
In our examples, the repos will first be created on GitHub (i.e., origin) and then *cloned* to your local Git repo on your computer.
...
**branch** - new/separate versions of the repo. It is a way to modify your scripts, while not changing your original code. If you're happy with your changes you can eventually merge them into your original code.
It is a feature in most version control systems.
...
If you want to test new changes, you would create another branch which could then be merged later.
