...
> Note: if you clone a repo from someone else GitHub account, you cannot contribute to the repo. Generally, you will make a `fork` if you are working collaboratively on a repo.
