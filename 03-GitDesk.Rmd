...
Really if we were being grammatically correct, we would probably refer to it as a commitment, or something like that. But as it stands, the word commit is used for both the process and the state. So you have to just git used to it.
~~~
...
> Git will not remeber any changes unless you create a `commit`
...
Now your files you tracked by git and uploaded to GitHub. Now that your files are synced with GitHub it’s important to remember a few points while working. Because you created the repo first in GitHub, the cloud version is the primary copy, referred to as the `origin`. 
