...
Now that you have mastered the basics of working with Git and GitHub using your preferred GUI you are ready to start collaborating (i.e., contribute to someones else's scripts). We will also walk you though how to transfer your repo to a new organization (e.g., Birds Canada) for longterm storage and management.
...
```{r imagetrans2, echo=FALSE, out.width="700px", fig.align='center'}
knitr::include_graphics("images/GitTransfer2.PNG")
```
...
```{r script remote, message=FALSE, eval=FALSE}
